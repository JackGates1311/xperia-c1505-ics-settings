...
.method private isVpnConnectable(I)Z
    .locals 2
...
.method public onContextItemSelected(Landroid/view/MenuItem;)Z
    ...
    invoke-virtual {v1}, Lcom/android/settings/vpn2/VpnSettings$VpnPreference;->getProfile()Lcom/android/settings/vpn2/VpnProfile;

    move-result-object v6

    invoke-direct {v3, v5, p0, v6, v4}, Lcom/android/settings/vpn2/VpnDialog;-><init>(Landroid/content/Context;Landroid/content/DialogInterface$OnClickListener;Lcom/android/settings/vpn2/VpnProfile;Z)V
    ...
    .line 264
    .local v2, "vpnProfile":Lcom/android/settings/vpn2/VpnProfile;
    iget-object v5, v2, Lcom/android/settings/vpn2/VpnProfile;->username:Ljava/lang/String;

    if-eqz v5, :cond_2

    const-string v5, ""

    iget-object v6, v2, Lcom/android/settings/vpn2/VpnProfile;->username:Ljava/lang/String;
    ...
    invoke-direct {v5, v6, p0, v2, v3}, Lcom/android/settings/vpn2/VpnDialog;-><init>(Landroid/content/Context;Landroid/content/DialogInterface$OnClickListener;Lcom/android/settings/vpn2/VpnProfile;Z)V
    ...
    .line 277
    .end local v2    # "vpnProfile":Lcom/android/settings/vpn2/VpnProfile;
    :pswitch_3
    iget-object v3, p0, Lcom/android/settings/vpn2/VpnSettings;->mSelectedKey:Ljava/lang/String;
...
.method public onCreateContextMenu(Landroid/view/ContextMenu;Landroid/view/View;Landroid/view/ContextMenu$ContextMenuInfo;)V
    ...
    invoke-static {v0}, Lcom/android/settings/vpn2/VpnSettings$VpnPreference;->access$000(Lcom/android/settings/vpn2/VpnSettings$VpnPreference;)I

    move-result v2

    invoke-direct {p0, v2}, Lcom/android/settings/vpn2/VpnSettings;->isVpnConnectable(I)Z
    ...
    .line 230
    :cond_2
    invoke-interface {p1, v4, v8, v4, v8}, Landroid/view/ContextMenu;->add(IIII)Landroid/view/MenuItem;
